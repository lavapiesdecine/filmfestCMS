<?php
	...
	class programacionController extends \core\Controller{
	    ...
	    public function index(){
			...
			for ($i = $fechaInicio; $i <= $fechaFin; $i+=86400) {
	 		...
	 		$html.="</div>";
	 		$this->_title = _("programacion.title");
	 		$this->_description = _("programacion.description");
